...
| `runtime/boxlang.production.json` | Enables the class-resolver cache and JSON console logging without test mappings; the compiled-class trusted cache stays off because ColdBox resolves LogBox appenders dynamically at startup. |
